            ...
            >
                <Link href={`/product/${product._id}`} className="block overflow-hidden bg-gray-50 aspect-[4/5] relative">
                    ...
                    <button
                        ...
                        className="absolute top-2 right-2 p-2 bg-white/80 hover:bg-white backdrop-blur-sm rounded-full text-[#1c1c1c] opacity-0 group-hover:opacity-100 transition-opacity transform hover:scale-110 z-10 shadow-sm"
                        title="Share"
                    >
